...
public class ProveedorController {
    ...
    public ResponseEntity<Map<String, Object>> listaPorID(@PathVariable Long id) {
        return service.listarProveedoresPorId(id);
    }

    @PostMapping
    public ResponseEntity<Map<String, Object>> agregar(@Valid @RequestBody Proveedor proveedor) {
        return service.agregarProveedor(proveedor);
    }

    @PutMapping("/{id}")
    public ResponseEntity<Map<String, Object>> editar(@RequestBody Proveedor proveedor, @PathVariable Long id) {
        return service.editarProveedor(proveedor, id);
    }
